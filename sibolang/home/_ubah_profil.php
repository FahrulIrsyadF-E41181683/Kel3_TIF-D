  ...
  if(isset($_POST['ubahfoto'])){ // Jika user menceklis checkbox yang ada di form ubah, lakukan :
    ...
    if(move_uploaded_file($tmp, $path)){ // Cek apakah gambar berhasil diupload atau tidak
      ...
      if($sql){ // Cek jika proses simpan ke database sukses atau tidak
        // Jika Sukses, Lakukan :
        header("location: home.php?page=profil"); // Redirect ke halaman home.php
      }else{
        // Jika Gagal, Lakukan :
        echo "<script>alert('Data gagal disimpan');document.location.href='home.php?page=profil'</script>\n";
      }
    }else{
    ...
    // Proses ubah data ke Database
      ...
      // Jika Sukses, Lakukan :
        echo "<script>alert('Data berhasil disimpan');document.location.href='home.php?page=profil'</script>\n"; // Redirect ke halaman admin.php
    }else{
      // Jika Gagal, Lakukan :
        echo "<script>alert('Data gagal disimpan');document.location.href='home.php?page=profil'</script>\n";
    }
