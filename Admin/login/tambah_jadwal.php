      ...
      <div class="mdc-drawer__content">
        ...
        <div class="mdc-list-group">
          <nav class="mdc-list mdc-drawer-menu">
            ...
            <div class="mdc-list-item mdc-drawer-item">
              <a class="mdc-drawer-link active" href="jadwal.php"><!--../../pages/forms/basic-forms.html-->
        ...
        <main class="content-wrapper">                                                  
            <button type="button" class="mdc-fab mdc-fab--extended" style="background-color: #7a00ff">
                <span class="material-icons mdc-fab__icon">save</span>
                    <a href="jadwal.php"class="mdc-fab__label" style="color: white;">Simpan</a>
            </button>
          <div class="mdc-layout-grid">
            <div class="mdc-layout-grid__inner">
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                <div class="mdc-card p-0">
                  <h6 class="card-title card-padding pb-0">TAMBAH DATA JADWAL</h6>
                  <div class="table-responsive">
                    <table class="table">
                        <tbody>
                            ...
                            <div class="mdc-notched-outline__leading"></div>
                            <div class="mdc-notched-outline__notch">
                                    <label for="text-field-hero-input" class="mdc-floating-label">Nama Lapangan</label>
                            </div>
                            <div class="mdc-notched-outline__trailing"></div>
                            </div>
                            </div>
                            ...
                            <div class="mdc-notched-outline__leading"></div>
                            <div class="mdc-notched-outline__notch">
                                    <label for="text-field-hero-input" class="mdc-floating-label">Harga Sewa</label>
                            </div>
                            <div class="mdc-notched-outline__trailing"></div>
                            </div>
                            </div>
