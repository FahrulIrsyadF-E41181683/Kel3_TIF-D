  ...
  // Proses simpan ke Database
    $sql = mysqli_query($connect, "INSERT INTO `admin`(`ID_ADMIN`,`NAMA_ADMIN`,`JENIS_KELAMIN`,`NOTLP_ADMIN`,`EMAIL_ADMIN`,`ALAMAT_ADMIN`,`PASSWORD_ADMIN`,`FOTO_ADMIN`) 
    VALUES ('$id_admin','$nm_admin','$jenis_kelamin','$no_hp','$email','$alamat','$password','$fotobaru');"); // Eksekusi/ Jalankan query dari variabel $query
